...
class ImageController extends BaseController {
	...
	public function index(){		
    	...
    	$list= M('Image')->where($map)->page($_GET['p'].',25')->order('id desc')->select();
    	$count=M('Image')->where($map)->count();// 查询满足要求的总记录数
    ...
    public function upload(){
        ...
        $upload->exts      =     array('gif','png','jpg','jpge');// 设置附件上传类型
