...
<div id="main-container" class="container" >
	...
	<section>
		<div class="span12">
			<caption>私聊客户</caption>			
			<table class="table">				
				<thead>
					<tr>
						<th>#</th>
						<th style="width:5%;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;">客户</th>
						<th>性别</th>
						<th>电话</th>
						<th>星座</th>
						<th>喜欢美食</th>
				...
				<tbody>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td><?php echo ($vo["fav_food"]); ?></td>
							<td><?php echo ($vo["fav_movie"]); ?></td>
							<td><?php echo ($vo["job"]); ?></td>
							<td><?php echo ($vo["time"]); ?></td>
							<td>
								<a href="<?php echo U('Cust/edit',array('id'=>$vo['id'],'rid'=>$_REQUEST['rid']));?>">编辑</a></td>
