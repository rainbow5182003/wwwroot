...
<section>
	<div class="span8">
		<img src="/wwwroot/Public/Home/images/banner_pic.png"/>
	</div>
	<div class="span4">
        <form class="login-form" action="/wwwroot/User/register" method="post" style="margin-top: 60px;">
          ...
          <div class="control-group">
            <div class="controls">
              ...
              <a href="<?php echo U('User/login');?>">点此登录</a>
            </div>
          </div>
        </form>
	</div>
