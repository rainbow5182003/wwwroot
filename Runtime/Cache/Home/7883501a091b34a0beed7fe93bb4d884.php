			...
			<table class="table" style="table-layout: fixed;font-size: 10px; color: #000088;">
				...
				<tbody> 
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td style="overflow:hidden;white-space:nowrap;text-overflow:ellipsis;"><?php echo ($vo["nickname"]); ?></td>
							<td style="overflow:hidden;white-space:nowrap;text-overflow:ellipsis;"><?php echo ($vo["cust_said"]); ?></td>
							<td style="overflow:hidden;white-space:nowrap;text-overflow:ellipsis;"><?php echo (strip_tags($vo["robot_said"])); ?></td>
							<td><?php echo ($vo["time"]); ?></td>
							<td >
								<a href="<?php echo U('Conversation/edit',array('id'=>$vo['id'],'rid'=>$_REQUEST['rid']));?>">编辑</a>
							</td>
