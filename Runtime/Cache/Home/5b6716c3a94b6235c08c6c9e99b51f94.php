        ...
        <div class="container">
            ...
            <div class="nav-collapse collapse">
                <ul class="nav">
		            ...
		            <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Chat/index',array('cid'=>$vo['id'],'rid'=>$_REQUEST['rid']));?>"><?php echo ($vo["cate"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>         
                </ul>
            </div>
...
<div id="main-container" class="container">
	...
	<section>
		...
		<div class="span12">
			<form action="<?php echo U('Emotion/upload');?>" enctype="multipart/form-data" method="post" style="float: right;">
						<input type="file" name="avatar" id="ups"/>
    	    </form>			   
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><img src="<?php echo ($vo["url"]); ?>" class="img-circle" width="80" height="80"><?php endforeach; endif; else: echo "" ;endif; ?>
...
(function(){
	...
	<script type="text/javascript">	
        ...
        'uploader'   : '<?php echo U("Emotion/upload");?>',
        'buttonText' : '上传',
